...
//console.log('========================= srp', ourDefaultCDNpath );
    var process_search_results = function(field, bib,ourDefaultCDNpath) {
        ...
        var getTitle4SRP = function(bib) {
            ...
            ////////////console.log(properlyFormattedHtmlString);https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/
        ...
        var friendly_print_resource_type = function(bib) {
            ...
            var htmlstring = '<span class="gen_info_labelSRP paddingRight2">Type: </span> ' +
                ' <img src="' + 'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/' + which_resource_type_icon +
        ...
        var getbibRecordFormat = function(bib) {
            ...
            } //end for//'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/'
            if (bib.marc.rtype() === 'BKS' || bib.marc.rtype() === 'SER' || bib.marc.rtype() === 'SCO') {
                ...
                if (has008 == true) {
                    ...
                    if (bib.marc.ctrl('008[24]') === 'b' || bib.marc.ctrl('008[25]') === 'b' || bib.marc.ctrl('008[26]') === 'b' || bib.marc.ctrl('008[27]') === 'b') {
                        ...
                        thebibRecordFormat = thebibRecordFormat + ' <img src="' + 'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/' + 'text_list_bullets.png" alt="bibliography" title="bibliography"> ' + ' Bibliography';
                    }
            ...
            if (has007 == true) { //has007 =="T"
                ...
                if (bib.marc.ctrl('007[0]') === 'c' && bib.marc.ctrl('007[1]') === 'r') { // Remote test
                    ...
                    thebibRecordFormat = thebibRecordFormat + ' <img src="' + 'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/' + 'drive_web.png" alt="Remote" title="Remote"> ' + 'Remote | ';
                }
                ...
                if (bib.marc.ctrl('007[0]') === 'v' && bib.marc.ctrl('007[1]') === 'f') { // Videocassette test
                    ...
                    thebibRecordFormat = thebibRecordFormat + '<img src="' + 'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/' + 'videocassette.png" alt="videocassette" title="videocassette"> ' + 'Videocassette | ';
                }
                if (bib.marc.ctrl('007[0]') === 'v' && bib.marc.ctrl('007[1]') === 'd') { // Videodisc test
                    // 007/00 =v   AND   007/01=d -> Videodisc
                    thebibRecordFormat = thebibRecordFormat + ' <img src="' + 'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/' + 'dvd.png" alt="DVD" title="DVD"> ' + 'Videodisc | ';
                }
                ...
                if ((bib.marc.ctrl('007[0]') === 's' && bib.marc.ctrl('007[1]') === 'd' && bib.marc.ctrl('007[3]') === 'f')) { // CD test
                    thebibRecordFormat = thebibRecordFormat + ' <img src="' + 'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/' + 'cd.png" alt="CD" title="CD"> ' + ' CD | ';
                    cdFound = true;
                }
                if ((bib.marc.ctrl('007[0]') === 's' && bib.marc.ctrl('007[1]') === 'd' && bib.marc.ctrl('007[3]') === 'b')) { // LP test
                    thebibRecordFormat = thebibRecordFormat + ' <img src="' + 'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/' + 'lp.png" alt="LP" title="LP"> ' + ' LP / Vinyl | ';
                    lpFound = true;
                }
            } //has007 =="T"
            if (cdFound === false) {
                ...
                if (bib.marc.rtype() === 'BKS') { //if 3
                    if (bib.marc.ctrl('008[24]') !== 'number_sign' && bib.marc.ctrl('008[24]') !== ' ' && bib.marc.ctrl('008[24]') !== '|' && bib.marc.ctrl('008[24]') != 'u') { //if 5
                        ...
                        properlyFormattedHtmlString = '<span class="main_divider">|</span><span class="gen_info_labelSRP paddingRight2">Nature of contents: </span>' +
                            '<img src="' + 'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/' + 'user.png" alt="NOC" title="NOC"> ' + '<span class="gen_info_dataitemSRP indent_data">' + thebibRecordNatureOfContents + '</span>';
                    } //if 5
                } //if 3
            } //if 0
            return properlyFormattedHtmlString;
            ...
            if (bib.marc.has('008')) { //if 0
                if (bib.marc.rtype() === 'SER') {
                    ...
                    if (bib.marc.ctrl('008[21]') !== ' ' && bib.marc.ctrl('008[21]') !== 'z' && bib.marc.ctrl('008[21]') !== '|') {
                        theTypeofContRes = ' <img src="' + 'https://cdn.jsdelivr.net/gh/Biblovation-files/prod@images/' + TypeofContResImage[bib.marc.ctrl('008[21]')] + '"alt="' +
